...
//------------------------------------------------
/////Sortie article
function maj_solde_article(ref_article, promo) {

    var AppelAjax = new Ajax.Request(
        "maj_solde_article.php", {
            parameters: {
...
function sortie_article_depuis_caisse(code_article) {
...
function create_categ(lib_art_categ, ref_art_categ_parent, libu, valu, libd, vald) {
    ...
    var AppelAjax = new Ajax.Request(
        ...
        "create_categ.php", {
            ...
            parameters: {
                ...
                ref_art_categ_parent: ref_art_categ_parent,
                libu: libu,
                libd: libd,
                valu: valu,
                vald: vald
...
function upadate_parametre_carac_nouvel_categ(nbr_carac) {


    var AppelAjax = new Ajax.Updater(
        "lib_carac_categ_table",
        "upadate_parametre_carac_nouvel_categ.php", {
            method: 'post',
            asynchronous: true,
...
function inserer_client_interet(ref_contact) {

    var AppelAjax = new Ajax.Request(
        "inserer_client_interet.php", {
            parameters: {
...
function supprimer_client_interet(ref_contact) {

    var AppelAjax = new Ajax.Request(
        "supprimer_client_interet.php", {
            parameters: {
                ref_contact: ref_contact
            },
            evalScripts: true,
...
/////Reception article
function reception_article_depuis_caisse(code_article) {
...
appelpage.prototype = {
    ...
    // creation_par_lot
    article_creation_par_lot: function() {

        window.location.href = "http://localhost/constructeur/sb4/profil_collab/#documents_edition.php?ref_doc=CDF-000000-00040";
        /*
        var AppelAjax = new Ajax.Updater(
            "messageok",
            "ajout_articles_par_lot.php", {
                method: 'post',
                asynchronous: true,
                contentType:  'application/x-www-form-urlencoded',
                encoding:     'UTF-8',
                parameters: {
                    recherche: '1',
					create_article: $F('create_article'), 
                    lib_article: $F('lib_article'),
                    ref_art_categ: $F('ref_art_categ_lot'),
					ref_constructeur: $F('ref_constructeur_lot'),
					tarif_tva: $F('tarif_tva'),
					id_tva: $F('id_tva'),
					taxation_pp: $F('taxation_pp').checked.value
					},
                evalScripts:true,
                onLoading:S_loading,
                onException: function () {
    ...
    catalogue_recherche_avancee_solde: function() {
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "catalogue_recherche_avancee_solde_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    catalogue_recherche_avancee1: function(id_stock) {


        var AppelAjax = new Ajax.Updater(
            "resultat",
            "catalogue_recherche_avancee_result1.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    detail_stock_dormant_recherche: function() {


        serie_recherche = ($('form_recherche_s_d').serialize(true));
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "detail_stock_dormant_recherche_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    detail_stock_recherche: function() {
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "detail_stock_recherche_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    // recherche cheque entreprise
    compte_bancaire_recherche_chq_entreprise: function() {
        var chq_en_cours = "0";
        ...
        var AppelAjax = new Ajax.Updater(
            "liste_chq",
            "compta_compte_bancaire_recherche_chq_entreprise_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
                parameters: {
                    ...
                    id_compte_bancaire: $F('id_compte_bancaire'),
                    montant: $("montant").value,
                    conatct: $("ref_contact_s").value,
                    num_cheque: $("num_cheque").value,
                    date_debut: $("date_debut").value,
                    date_fin: $("date_fin").value,
                    debut_echeance: $("debut_echeance").value,
                    fin_echeance: $("fin_echeance").value,
                    delta_montant: $("delta_montant").value,
                    cheq_en_cours: chq_en_cours,
                    cheq_en_archive: chq_en_archive,
                    page_to_show: $F('page_to_show'),
                    orderby: $F('orderby'),
                    orderorder: $F('orderorder')
                },
    ...
    catalogue_recherche_avancee2: function(id_stock) {


        var AppelAjax = new Ajax.Updater(
            "resultat",
            "catalogue_recherche_avancee_result2.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    // export articles en exel
    export_articles_exel: function() {
        historique_request[1] = new Array(historique[0]);
        historique_request[1][1] = "avancee";
        //historique_request[1]["lib_art_categ_a"] =$('lib_art_categ_a').innerHTML;
        ...
        var parametres = '';
        if ($('in_stock').checked == true) {
            parametres += '&in_stock=1';
        };
        if ($('is_nouveau').checked == true) {
            parametres += '&is_nouveau=1';
        };
        if ($('in_promotion').checked == true) {
            parametres += '&in_promotion=1';
        };
        if ($('in_archive').checked == true) {
            parametres += '&in_archive=1';
        };
        ...
        //alert(parametres);
        window.open('export_articles_exel.php?lib_article=' + $('lib_article').value + '&date_debut=' + $('date_debut').value + '&date_fin=' + $('date_fin').value + '&ref_art_categ=' + $("ref_art_categ").options[$("ref_art_categ").selectedIndex].value + '&ref_constructeur=' + $("ref_constructeur").options[$("ref_constructeur").selectedIndex].value + '&orderby=' + $('orderby').value + '&orderorder=' + $('orderorder').value + '&id_stock=' + $('id_stock').value + '&id_tarif=' + $('id_tarif').value + '&recherche=1' + parametres + '', '_blank');
    },
    ...
    //appel les réponses pour le moteur de recherche articles par lot
    document_recherche_article_parlot: function() {

        historique_request[3] = new Array(historique[0]);
        historique_request[3][1] = "simple";
        historique_request[3]["ref_art_categ_s2"] = $F('ref_art_categ_s2');
        historique_request[3]["ref_constructeur_s2"] = $F('ref_constructeur_s2');
        //historique_request[3]["lib_art_categ_s"] 		=$('lib_art_categ_s').innerHTML;
        historique_request[3]["lib_article_s2"] = $F('lib_article_s2');
        historique_request[3]["recherche_auto2"] = $F('recherche_auto2');
        historique_request[3]["from_rapide_search"] = from_rapide_search;
        historique_request[3]["page_to_show_s2"] = $F('page_to_show_s');
        historique_request[3]["orderby_s2"] = $F('orderby_s2');
        historique_request[3]["orderorder_s"] = $F('orderorder_s');


        var AppelAjax = new Ajax.Updater(
            "resultat2",
            "documents_recherche_articles_parlot.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
                parameters: {
                    recherche: '1',
                    ref_art_categ: $F('ref_art_categ_s2'),
                    lib_article: escape($F('lib_article_s2')),
                    page_to_show: $F('page_to_show_s2'),
                    ref_constructeur: $F('ref_constructeur_s2'),
                    orderby: $F('orderby_s2'),
                    orderorder: $F('orderorder_s2'),
                    ref_doc: $F('ref_doc'),
                    recherche_auto: $F('recherche_auto2'),
                    from_rapide_search: from_rapide_search
                },
                evalScripts: true,
                onLoading: S_loading,
    ...
    //appel les réponses pour le moteur de recherche articles par lot
    document_recherche_fils_article_parlot: function(ref_article) {
        // alert("amir");
        historique_request[3] = new Array(historique[0]);
        historique_request[3][1] = "simple";
        historique_request[3]["ref_art_categ_s2"] = $F('ref_art_categ_s2');
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat2",
            "documents_recherche_fils_articles_parlot.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
                parameters: {
                    recherche: '1',
                    ref_article_parent: ref_article,
                    ref_art_categ: $F('ref_art_categ_s2'),
                    lib_article: escape($F('lib_article_s2')),
                    page_to_show: $F('page_to_show_s2'),
                    ref_constructeur: $F('ref_constructeur_s2'),
    ...
    //appel les réponses pour le moteur de recherche articles par lot
    document_recherche_article_parents: function() {

        /*alert($('ref_art_categ_s2'));
        alert($F('ref_constructeur_s2'));
        alert();
        alert();
        alert();
        alert();
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat2",
            "documents_recherche_articles_parents_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    //appel les réponses pour le moteur de recherche de tickets d'aujourd'hui
    documents_recherche_tickets_aujourduit: function() {
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "documents_recherche_tickets_aujourdui_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    //appel les réponses pour le moteur de recherche de facture de client a regler
    documents_recherche_facture_client_a_regler: function() {
        ...
        historique_request[2]["ref_contact_nom_s"] = $('ref_contact_nom_s').innerHTML;
        historique_request[2]["id_type_doc_s"] = $F('id_type_doc_s');
        historique_request[2]["id_etat_doc_s"] = 18;
        historique_request[2]["ref_doc_s"] = $F('ref_doc_s');
        historique_request[2]["page_to_show_s"] = $F('page_to_show_s');
        historique_request[2]["orderby_s"] = $F('orderby_s');
        historique_request[2]["orderorder_s"] = $F('orderorder_s');
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "documents_recherche_facture_a_regler_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
    ...
    //appel les réponses pour le moteur de recherche de tickets de client a regler
    documents_recherche_tickets_client_a_regler: function() {
        ...
        historique_request[2]["ref_contact_nom_s"] = $('ref_contact_nom_s').innerHTML;
        historique_request[2]["id_type_doc_s"] = $F('id_type_doc_s');
        historique_request[2]["id_etat_doc_s"] = 67;
        historique_request[2]["ref_doc_s"] = $F('ref_doc_s');
        historique_request[2]["page_to_show_s"] = $F('page_to_show_s');
        historique_request[2]["orderby_s"] = $F('orderby_s');
        historique_request[2]["orderorder_s"] = $F('orderorder_s');
        ...
        var AppelAjax = new Ajax.Updater(
            "resultat",
            "documents_recherche_tickets_a_regler_result.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
