    ...
    var AppelAjax = new Ajax.Updater(contenttag + "_li_" + id_index_contentcoord,
        pagetogo + ".php", {
            ...
            parameters: {
                ...
                ref: ref_caiu,
                compte_info: id_index_contentcoord
            },
            evalScripts: true,
            onLoading: S_loading,
...
function insert_profil_button(nprofil, intitule_profil) {
    ...
    Event.observe("typeprofil_menu_" + nprofil, "click", function(evt) {
        Event.stop(evt);
        view_menu_1("x_typeprofil" + nprofil, "typeprofil_menu_" + nprofil, array_menu_v_contact);
        set_tomax_height("x_typeprofil" + nprofil, -46);
        set_tomax_height("typeprofil" + nprofil, -52);
    }, false);
...
function link_contact_to_contact_view_depuis(num_serie, id_liaison_type, ref_contact_A, ref_contact_B, lib_contact) {
    var AppelAjax = new Ajax.Request(
        "annuaire_edition_liaison_add.php", {
            parameters: {
                ref_contact_A: ref_contact_B,
                ref_contact_B: ref_contact_A,
                id_liaison_type: id_liaison_type
            },
            evalScripts: true,
            onLoading: S_loading,
...
function donner_cadeaux(ref_client, val_cadeau) {

    page.traitecontent("resultat_cadeau", "donner_cadeau_client.php?ref_contact=" + ref_client + "&val_cadeau=" + val_cadeau + " ", true, "resultat_cadeau");
