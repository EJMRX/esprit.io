...
function edition_formule_tarifaire(id_field_formule) {
    ...
    if ($("assistant_rep_step3_arrondi")) {
        if (arrondi_formule == "") {
            ...
            if (arrondi_formule.indexOf("=") >= 0) {
                $("assistant_rep_step3_arrondi").selectedIndex = 1;
                pas_arrondi = arrondi_formule.substring(arrondi_formule.indexOf("=") + 1, arrondi_formule.length - 1);
            }
            if (arrondi_formule.indexOf("<") >= 0) {
                $("assistant_rep_step3_arrondi").selectedIndex = 2;
                pas_arrondi = arrondi_formule.substring(arrondi_formule.indexOf("<") + 1, arrondi_formule.length - 1);
            }
            if (arrondi_formule.indexOf(">") >= 0) {
                $("assistant_rep_step3_arrondi").selectedIndex = 3;
                pas_arrondi = arrondi_formule.substring(arrondi_formule.indexOf(">") + 1, arrondi_formule.length - 1);
            }
