...
function action_recherche_article(action_selection, second_id, length_list) {

    var liste_doc = "";
    for (i = 0; i < length_list; i++) {
        if ($("check" + second_id + "_" + i)) {
            if ($("check" + second_id + "_" + i).checked) {
                liste_doc += "&ref_article" + i + "=" + $("check" + second_id + "_" + i).value;
            }
        }
    }
    ...
    if (liste_doc != "") {
        if (action_selection == "print") {
            window.open("articles_recherche_result_action.php?fonction_generer=" + action_selection + liste_doc, "_blank");
...
function show_resume_stock_parent(ref_article, evt) {
    if ($('resume_stock_parent').style.display == 'block') {
        $('resume_stock_parent').style.display = 'none';
        ...
        var AppelAjax = new Ajax.Updater(
            ...
            "catalogue_articles_resume_stock.php", {
                ...
                onLoading: S_loading,
                onComplete: function() {
                    $("resume_stock_iframe").style.height = return_height_element("resume_stock_parent") + "px";
                    $("resume_stock_iframe").style.width = return_width_element("resume_stock") + "px";
                    $("resume_stock_parent").style.position = 'absolute';
                    ...
                    if ($("pop_up_view_categ_carac")) {
                        ...
                        $("resume_stock_parent").style.top = ($("pop_up_view_categ_carac").scrollTop + evt.clientY - 120) + "px";
                        $("resume_stock_parent").style.left = (evt.clientX - 800) + "px";
                        //deplacement iframe
                    ...
                    //page catalogue recherche sans detail
                        ...
                        //deplacement popup selon souris et scrollbar
                        $("resume_stock_parent").style.top = (evt.clientY - 45) + "px";
                        $("resume_stock_parent").style.left = (evt.clientX - 450) + "px";
                        //deplacement iframe
                    ...
                    $('resume_stock_parent').style.display = 'block';
...
function close_resume_tarif() {
    $('resume_tarif').hide();
    $('resume_tarif_iframe').hide();
    $('resume_tarif').innerHTML = "";
}


//résumé des stocks dans les recherches d'articles
function show_resume_tarif(ref_article, evt) {
    if ($('resume_tarif').style.display == 'block') {
        $('resume_tarif').style.display = 'none';
        $('resume_tarif_iframe').style.display = 'none';
    } else {
        $('resume_tarif').style.display = 'none';
        $('resume_tarif_iframe').style.display = 'none';
        ...
        var AppelAjax = new Ajax.Updater(
            "resume_tarif",
            "catalogue_articles_resume_tarif.php", {
                method: 'post',
                asynchronous: true,
                contentType: 'application/x-www-form-urlencoded',
                encoding: 'UTF-8',
                ...
                onLoading: S_loading,
                onComplete: function() {
                    $("resume_tarif_iframe").style.height = return_height_element("resume_tarif") + "px";
                    $("resume_tarif_iframe").style.width = return_width_element("resume_tarif") + "px";
                    $("resume_tarif").style.position = 'absolute';
                    $('resume_tarif_iframe').style.position = 'absolute';
                    $('resume_tarif_iframe').style.display = 'block';
                    //Enlever la scrollbar horizontale ou ajouter la scroll b ar correspondante aux calculs
                    if ($("pop_up_view_categ_carac")) {
                        $("pop_up_view_categ_carac").style.overflowX = 'hidden';
                        //deplacement popup selon souris et scrollbar
                        $("resume_tarif").style.top = ($("pop_up_view_categ_carac").scrollTop + evt.clientY - 120) + "px";
                        $("resume_tarif").style.left = (evt.clientX - 800) + "px";
                        //deplacement iframe
                        $('resume_tarif_iframe').style.top = ($("pop_up_view_categ_carac").scrollTop + evt.clientY - 120) + "px";
                        $('resume_tarif_iframe').style.left = (evt.clientX - 800) + "px";
                        //alert("carac_view");
                    }
                    //page catalogue recherche sans detail
                    else if ($("sub_content").scrollTop) {
                        //deplacement popup selon souris et scrollbar
                        $("resume_tarif").style.top = (evt.clientY - 45) + "px";
                        $("resume_tarif").style.left = (evt.clientX - 450) + "px";
                        //deplacement iframe
                        $('resume_tarif_iframe').style.top = (evt.clientY - 45) + "px";
                        $('resume_tarif_iframe').style.left = (evt.clientX - 450) + "px";
                        //alert("sub_content");
                    } else {
                        $("resume_tarif").style.top = (evt.clientY - 45) + "px";
                        $("resume_tarif").style.left = (evt.clientX - 450) + "px";
                    ...
                    $('resume_tarif').style.display = 'block';
