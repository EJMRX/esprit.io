...
//transfert rapid fond de caisse 

tab_alerte["transfert_rapide_fond_caisse"] = new Array('Transfert Caisse', 'Confirmez le transfert des fonds de caisse', '<input type="submit" name="bouton1" id="bouton1" value="Transferer" /><input type="submit" id="bouton0" name="bouton0" value="Annuler" />');